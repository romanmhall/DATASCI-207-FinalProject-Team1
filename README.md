# Evaluating Behavioral Dynamics & Alternative Data for Thin-File Credit Default Prediction (`credit_project`)

**Course**: UC Berkeley DATASCI 207 (Machine Learning at Scale)  
**Team**: Advik Goel, Faisal, Roman Hall, Tung La  
**GitHub Repository**: [https://github.com/romanmhall/DATASCI-207-FinalProject-Team1](https://github.com/romanmhall/DATASCI-207-FinalProject-Team1)  
**Primary Dataset**: [Home Credit Default Risk (Kaggle)](https://www.kaggle.com/competitions/home-credit-default-risk)

---

## Project Overview
This project benchmarks machine learning algorithms (Linear Scorecards, Gradient Boosted Trees, and Deep Tabular Neural Networks in TensorFlow) to assess whether alternative external scoring proxies, past application trajectories, and granular installment repayment dynamics can accurately predict loan default for "thin-file" and unbanked borrowers.
